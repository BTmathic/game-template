...
class Entity:
    ...
    """
    def __init__(self, x, y, char, color, name, render_order=RenderOrder.CORPSE, blocks=False, fighter=None, ai=None,
    ...
    def move_astar(self, target, entities, game_map):
        ...
        # Also check that the object isn't self or the target (so that the start and the end points are free)
        ...
        # monsters from running around the map if there is an alternative path really far away
